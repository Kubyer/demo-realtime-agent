...
func NewCartesiaClient(wsURL, apiKey, voiceID string, log *slog.Logger) *CartesiaClient {
	return &CartesiaClient{wsURL: wsURL, apiKey: apiKey, voiceID: voiceID, log: log}
}
...
func (c *CartesiaClient) Stream(ctx context.Context, sentenceCh <-chan string) (<-chan []byte, error) {
